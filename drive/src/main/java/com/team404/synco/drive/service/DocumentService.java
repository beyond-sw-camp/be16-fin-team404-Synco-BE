...
public class DocumentService {
    ...
    public DriveItemDto getDocument(Long documentSeq) {
        try {
            ...
            throw new RuntimeException("문서 조회에 실패했습니다.", e);
        }
    }
    ...
    public DriveItemDto updateDocumentContent(Long documentSeq, UpdateDocumentRequest request) {
        try {
            ...
            if (request.getIsLocked() != null) {
                document.updateLockStatus(request.getIsLocked() ? YnColumn.IS_TRUE : YnColumn.IS_FALSE);
            }
    ...
    public DriveItemDto toggleDocumentLock(Long documentSeq) {
        try {
            ...
            log.error("문서 잠금 토글 실패", e);
            throw new RuntimeException("문서 잠금 토글에 실패했습니다.", e);
        }
    }
